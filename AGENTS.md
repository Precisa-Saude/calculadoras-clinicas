# Specific instructions — calculadoras-clinicas
...
Valid scopes: `calculadoras`, `docs`, `ci`, `deps`, `lint`, `config`.
...
| Field         | Value                                            |
| ------------- | ------------------------------------------------ |
| Port registry | `/tmp/calculadoras-clinicas-worktree-ports.json` |
